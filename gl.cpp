...
ShaderProgram::File::File(const std::string& path)
...
ShaderProgram::ShaderProgram(const std::string& vertex_shader_source,
...
void ShaderProgram::set_uniform_buffer(const std::string& name,
    GLuint binding)
{
    ...
    : Texture(GL_TEXTURE_2D)
{
    ...
    glTexImage2D(target, 0, image.format(), image.width(), image.height(), 0,
...
void Texture::set_parameter(GLenum pname, const GLfloat* param)
{
